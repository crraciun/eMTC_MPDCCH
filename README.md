...
It includes:
  * srsUE - a complete SDR eMTC UE application featuring all layers from PHY to IP
  * srsENB - a complete SDR eMTC eNodeB application
  * srsEPC - a light-weight LTE core network implementation with MME, HSS and S/P-GW
  * a highly modular set of common libraries for PHY, MAC, RLC, PDCP, RRC, NAS, S1AP and GW layers.

eMTC is released under the AGPLv3 license and uses software from the OpenLTE project (http://sourceforge.net/projects/openlte) for some security functions and for RRC/NAS message parsing.
 ...
 * Huawei P9/P9lite, P10/P10lite, P20/P20lite, P Smart 2019, Mate 20/20lite
 * Huawei dongles: E3276 and E398
 * IPhone Xs, 8 Plus
 * Huawei ME309-562 - eMTC features
 * Sierra EM7455 - eMTC features
